...
let Organization = class Organization extends entities_1.TenantBaseEntity {
    name;
    isDefault;
    logo;
    description;
...
__decorate([
    (0, entity_1.MultiORMManyToOne)(() => tenant_entity_1.Tenant, (it) => it.organizations, {
        onDelete: 'CASCADE',
    }),
    __metadata("design:type", tenant_entity_1.Tenant)
], Organization.prototype, "tenant", void 0);
exports.Organization = Organization = __decorate([
    (0, entity_1.MultiORMEntity)('organization')
], Organization);
